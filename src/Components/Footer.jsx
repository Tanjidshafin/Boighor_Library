            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="col-span-1">
                        <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-[#1A365D] mb-4">
                            BoiGhor
                        </h2>
                        <p className="text-gray-600 dark:text-gray-400 mb-4">
                            Your modern book library for discovering, reading, and sharing great books.
                        </p>
                    </div>
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-300 mb-4">Connect With Us</h3>
                ...
                <div className="border-t border-gray-200 dark:border-gray-400 mt-8 pt-8 text-center">
